...
\begin{wrapfigure}{r}{0.6\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{Media/Graphs/valuesVaryb2.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.6\textwidth}
    \centering
    \includegraphics[width=0.49\textwidth]{Media/Graphs/valuesVaryb3.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.6\textwidth}
    \centering
    \includegraphics[width=0.48\textwidth, ]{Media/Graphs/valuesVaryb4.png}
\end{wrapfigure}
